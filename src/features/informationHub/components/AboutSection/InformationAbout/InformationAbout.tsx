    ...
    <div className="fex flex-col items-center w-full lg:w-1/2">
      ...
      <div className="mt-6 space-y-4">
        <div className="flex gap-8">
          <p className="w-16 text-ui-secondary font-bold">{t("ABOUT.NAME")}</p>
          <p className="font-bold text-base">:</p>
          <p>{t("ABOUT.MY_NAME")}</p>
        </div>
        <div className="flex gap-8">
          <p className="w-16 text-ui-secondary font-bold">{t("ABOUT.PHONE")}</p>
          <p className="font-bold text-base">:</p>
        ...
        <div className="flex gap-8">
          <p className="w-16 text-ui-secondary font-bold">{t("ABOUT.EMAIL")}</p>
          <p className="font-bold text-base">:</p>
        ...
        <div className="flex gap-8">
          <p className="w-16 text-ui-secondary font-bold">
            {t("ABOUT.FREELANCE")}
          </p>
          <p className="font-bold text-base">:</p>
